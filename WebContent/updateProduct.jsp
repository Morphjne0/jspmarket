			...
			<div class = "col-md-7">
				...
				<div class = "form-group row">
					...
					<div class = "col-sm-3">
						...
						control" value = "<%=rs.getString("p_unitPrice")%>">
					</div>
				</div>
				<div class = "form-group row">
				...
				<div class ="form-group row">
					...
					<div class = "col-sm-3">
						...
						control" value = "<%=rs.getString("p_manufacturer") %>">
					</div>
				</div>
				<div class ="form-group row">
					...
					<div class = "col-sm-3">
						...
						control" value = "<%=rs.getString("p_category") %>">
					</div>
				</div>
				<div class ="form-group row">
					...
					<div class = "col-sm-3">
						...
						control" value = "<%=rs.getString("p_unitsInStock") %>">
					</div>
				</div>
				<div class ="form-group row">
