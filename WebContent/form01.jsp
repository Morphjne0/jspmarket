...
<body>
	...
	<p> 취미 : 독서<input type="checkbox" name="hobby1" checked>
			  ...
			  게임<input type="checkbox" name="hobby4">
			  요리<input type="checkbox" name="hobby5">
			  다도<input type="checkbox" name="hobby6">
			  캠핑<input type="checkbox" name="hobby7">
			  원예<input type="checkbox" name="hobby8">
