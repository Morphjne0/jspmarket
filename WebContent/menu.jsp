...
<nav class ="navbar navbar-expand navbar-dark bg-dark">
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand" href=" ./Welcome.jsp">Market M</a>		
		</div>
		<div>
		...
		<ul class="navbar-nav mr-auto">
			<c:choose>
					<c:when test = "${empty sessionId}">
						...
						value="/loginMember.jsp"/>">로그인</a></li>
						<li class = "nav-item"><a class="nav-link" href="<c:url 
						value="/addMember.jsp"/>">회원 가입</a></li>
					</c:when>
					<c:otherwise>
					<li style = "padding-top: 7px; color:"red">[<%=sessionId%>님 ]</li>
					<li class = "nav-item"><a class = "nav-link" href = "<c:url 
